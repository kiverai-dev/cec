...
### Воркфлоу
1. Пользователь загружает PDF файл, изображение (скриншот) или архив (ZIP/RAR)
2. Извлечение текста из PDF или распознавание текста на изображении (OCR, Tesseract)
...
| OCR_LANG | rus+eng | Языки распознавания текста (Tesseract) |
